...
@OpenAPIDefinition(
        info = @Info(
                title = "Client API - Veloso",
                version = "1.0",
                description = "API for managing clients with validations, advanced security, social login with Google and authorization server OAuth2 with JWT",
                contact = @Contact(
                        name = "Gabriel Veloso",
